...
* Free-shipping thresholds per delivery option (a courier-level threshold overrides them), shared parcel dimensions and contents description for all couriers, per-option card-payment control for Speedy COD.
