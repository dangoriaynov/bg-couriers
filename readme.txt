...
* Added: "Where to ask for the destination" (WooCommerce > Settings > Shipping > BG Couriers > Checkout). The town/office/locker picker can now sit under the customer's details, right after the phone number, instead of inside the order-review table. On a checkout with add-ons, gift options or a long totals table, the picker was the last thing a customer reached, after everything optional. The courier choice and the price stay in the table. Default: unchanged (with the shipping method).
