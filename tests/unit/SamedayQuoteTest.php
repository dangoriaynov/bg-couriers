 ...
 * the response must map to a live BGC_Quote. Shapes LIVE-CONFIRMED on the BG demo env (2026-07-23):
...
final class SamedayQuoteTest extends TestCase {
    ...
    public function test_parse_price_reads_amount_matching_store_currency(): void {
        $q = BGC_Sameday::parse_price(['amount' => 4.5, 'currency' => 'EUR', 'time' => 96], 'EUR');
    ...
    public function test_parse_price_converts_bgn_to_eur_over_the_peg(): void {
        $q = BGC_Sameday::parse_price(['amount' => 19.5583, 'currency' => 'BGN'], 'EUR');
    ...
    public function test_parse_price_rejects_a_foreign_currency(): void {
        ...
        BGC_Sameday::parse_price($this->fx('estimate.json'), 'EUR');
    }
