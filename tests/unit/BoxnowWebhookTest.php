...
require_once dirname(__DIR__, 2) . '/includes/Couriers/class-bgc-boxnow-webhook.php';
...
final class BoxnowWebhookTest extends TestCase {
    ...
    public function test_valid_signature_passes(): void {
        ...
        $this->assertTrue(BGC_Boxnow_Webhook::verify($body, $secret));
    }
