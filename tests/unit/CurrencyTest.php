...
final class CurrencyTest extends TestCase {
    public function test_bgn_to_eur_uses_peg(): void {
        $this->assertEqualsWithDelta(10.00, BGCouriers_Currency::convert(19.5583, 'BGN', 'EUR'), 0.001);
    }
    public function test_eur_to_bgn_uses_peg(): void {
        $this->assertEqualsWithDelta(19.5583, BGCouriers_Currency::convert(10.00, 'EUR', 'BGN'), 0.001);
    }
    public function test_dual_disabled_returns_single(): void {
        $this->assertSame('19.56 лв.', BGCouriers_Currency::dual(19.5583, 'BGN', false));
    }
    public function test_dual_enabled_appends_other(): void {
        $this->assertSame('19.56 лв. (10.00 €)', BGCouriers_Currency::dual(19.5583, 'BGN', true));
    }
    public function test_shipping_price_eur_to_bgn_peg(): void {
        ...
        $this->assertEqualsWithDelta(7.80, BGCouriers_Currency::convert(3.99, 'EUR', 'BGN'), 0.005);
    }
}
