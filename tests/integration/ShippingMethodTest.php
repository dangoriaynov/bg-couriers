...
final class ShippingMethodTest extends WP_UnitTestCase {
    public function set_up() { parent::set_up(); BGCouriers_Schema::create(); BGCouriers_Rates::set('speedy','office', BGCouriers_Zones::COUNTRY,5.55, get_woocommerce_currency());  bgcouriers_test_set_up_courier('speedy');
