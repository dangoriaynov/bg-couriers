...
class BGCouriers_Method_Sameday extends WC_Shipping_Method {
    public function __construct($instance_id = 0) {
        $this->id = 'bgcouriers_sameday';
    ...
    public function calculate_shipping($package = []) {
        ...
        // "Enable Sameday" was a switch that changed everything except the checkout. A zone entry is
        ...
        if (BGCouriers_Settings::courier_config('sameday') === null) { return; }
        ...
        $sel     = BGCouriers_Pricing::selection_for('sameday');
        $method  = $sel['method'];
        $site_id = $sel['site_id'];
