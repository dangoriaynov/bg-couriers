...
class BGCouriers_Method_Econt extends WC_Shipping_Method {
    ...
    public function calculate_shipping($package = []) {
        ...
        if (WC()->cart && self::is_free((float) WC()->cart->get_subtotal(), BGCouriers_Settings::free_shipping('econt', $method))) {
            $cost = 0.0;
        }
        ...
        $this->add_rate([
            ...
            'meta_data' => ['_bgcouriers_source' => $quote->source, '_bgcouriers_method' => $method],
        ]);
    }
}
