...
(function($){
    ...
    private function pigeon_courier_fields(): array {
        return [
            ...
            ['type' => 'checkbox', 'id' => 'bgc_pigeon_sandbox', 'title' => __('Sandbox (test) account', 'bg-couriers'),
                'desc' => __('Use the Pigeon sandbox/test API (api-demo.pigeonexpress.com) with your test key & secret. Leave unchecked for the live production account.', 'bg-couriers'),
                'default' => 'no'],
    ...
    private function boxnow_courier_fields(): array {
        return [
            ...
            ['type' => 'select', 'id' => 'bgc_boxnow_api_url', 'title' => __('API environment', 'bg-couriers'),
                'options' => [
                    'https://api-production.boxnow.bg' => __('Production', 'bg-couriers'),
                    'https://api-stage.boxnow.bg'      => __('Test', 'bg-couriers'),
                ],
                'desc' => __('Use Production for live orders; use Test only for trying it out with test credentials.', 'bg-couriers'),
