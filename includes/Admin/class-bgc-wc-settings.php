...
(function($){
    ...
    private function pigeon_courier_fields(): array {
        return [
            ...
            ['type' => 'text', 'id' => 'bgc_pigeon_base_url', 'title' => __('API base URL (advanced)', 'bg-couriers'),
                'desc' => __('Optional. Overrides the Pigeon API host - only for a sandbox/test account (e.g. https://api-demo.pigeonexpress.com). Leave empty to use the production API. Most merchants never change this.', 'bg-couriers'),
                'default' => '', 'autoload' => false],
            ...
            ['type' => 'number', 'id' => 'bgc_pigeon_box_length', 'title' => __('Default parcel length (cm)', 'bg-couriers'),
                'desc' => __('cm', 'bg-couriers'), 'desc_tip' => __('Pigeon requires parcel dimensions (length x width x height, in centimetres) on every quote and label. These defaults are used when an order has no dimensions of its own.', 'bg-couriers'),
                'default' => '40', 'custom_attributes' => ['min' => '1', 'step' => '1']],
            ['type' => 'number', 'id' => 'bgc_pigeon_box_width', 'title' => __('Default parcel width (cm)', 'bg-couriers'), 'desc' => __('cm', 'bg-couriers'),
                'default' => '40', 'custom_attributes' => ['min' => '1', 'step' => '1']],
            ['type' => 'number', 'id' => 'bgc_pigeon_box_height', 'title' => __('Default parcel height (cm)', 'bg-couriers'), 'desc' => __('cm', 'bg-couriers'),
                'default' => '40', 'custom_attributes' => ['min' => '1', 'step' => '1']],
